...
% También puede emplearse Visual Studio Code con la extensión Latex WorkShop.
%
...
% -------------------------
\makeatletter 
\@tituloPrimera{Plantilla guía de TFG para la ESI-UCLM} % 1ª Línea
\@tituloSegunda{Curso de {\LaTeX{}} esencial} % OPT.: Títulos largos.
...
\@autorline{Autor: \autor}
\@tutline{Tutor/a: Quien tutoriza}
%\@cotutline{Cotutor/a: Quien cotutoriza} % No borrar, sino dejar en blanco
\@cotutline{} % No borrar, sino dejar en blanco
