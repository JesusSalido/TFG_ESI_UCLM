...
\usepackage{formato} % Carga de paquetes en background
%===

% OPT: Niveles de índice y numeración de secciones
...
\input{./part1/PortadasESI} % Diseño de portadas
%\input{./part1/PortadaETSII} % Por ej.,: Otras portadas
%\includepdf{fichero_portada.pdf} % Incluso como fichero PDF

\input{./part1/Resumen} % Resumen/Abstract
\input{./part1/Agradecimientos} % Agradecimientos etc.

\input{./part1/Notacion} % [OPT:] Notación empleada.
\input{./part1/Indices} % Índice de contenido, figuras, tablas, listados, etc.
% END_FOLD
%--- (FIN FRONTMATTER)
...
% OPT.: Ficheros incluidos correspondientes a los part2_caps.
% Ubicados en ./part2_caps por mayor comodidad. Puede cambiarse la ruta.
\include{./part2_caps/1_Introduccion}
\include{./part2_caps/2_Objetivo}
\include{./part2_caps/3_Planificacion}
\include{./part2_caps/4_Desarrollo}
\include{./part2_caps/5_Conclusiones}
%--- (FIN MAINMATTER)
...
% OPT: Activa bibitems para la bibliografía descomentando línea sig.
%\bibitemrefstrue 
...
\else % OPT: Estilo en bibliografía
	\bibliography{bibliografia}   % Nombre del fichero .bib (sin extensión)
...
\include{./part3_anexos/AnexoA} % Apéndice A (opcionales)
\include{./part3_anexos/AnexoB} % Apéndice A (opcionales)
