...
A continuación se muestran algunos ejemplos para la inclusión de elementos en el documento como listas, tablas y figuras. Todos estos ejemplos se han presentado en al curso de \LaTeX{}\cite{salido10} y tanto estos como los recogidos en varias obras de referencia se pueden emplear para preparar este documento \cite{goos07,cascales03,goos07,lamport94,oetiker14,wikibookLaTex10}.
