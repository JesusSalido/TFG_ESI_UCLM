...
\usepackage{amsmath,amsthm,amssymb,amsfonts}	% OPT.: Mejoras cuando hay matemáticas
...
%DVI)
\usepackage{ctable}	% OPT.: Ajustes para tablas
...
%
% -------------------------
% EDITAR: Se introduce para poder ajustar el espacio interlineado a 1,5 líneas
%\onehalfspacing % Comentar si se desea el interlineado por defecto
