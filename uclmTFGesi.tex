...
\cotutor{<co-tutor(a) (nombre apellidos)>}	% Comentar si no existe
\instEdu{UNIVERSIDAD DE CASTILLA-LA MANCHA}
% Fichero con escudo de la institución
% Esa el logo de la ESI que prefieras (la normativa no especifica obligatoriedad).
...
% EDITAR: Configurar la portadilla de acuerdo a los elementos necesario (número y género), Ver ejemplos.
\portadillaTFG{Autor}{Tutor}{Co-tutor}	% Portada interior (con tutor y co-tutor)
%--- Ejemplos de uso
%\portadillaTFG{Autora}{Tutor}	% Portada interior (sin co-tutor)
%\portadillaTFG{Autor}{Tutor}{Co-tutora} % Portada interior (con tutor y co-tutora)
% Se añaden los elementos mencionados
%---
