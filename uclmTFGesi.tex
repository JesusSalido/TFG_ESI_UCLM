...
\usepackage[spanish]{uclmTFGesi} % Opción de idioma de la memoria y prefijos de género.
...
% EDITAR: Valores para el PDF.	
	pdftitle={Plantilla guía de TFG para la ESI-UCLM}, % Título
...
Por contribuir a que cada día me ilusione aprender algo nuevo} % Como mucho dos líneas (no confundir con los agradecimientos).
% -------------------------
