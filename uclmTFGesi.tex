...
\mesTF{septiembre}        			% Mes de defensa
\monthTF{September}        		
...
\makeatletter
% NOTA: Ajustes y colores de los enlaces y marcadores en el texto
...
%    hidelinks,               % Oculta colores en los enlaces
...
\addcontentsline{toc}{chapter}{\bibname} % Añade la bibliografía al Índice de contenidos. Se debe mantener cuando se desean subbibliografías.
...
% ieeetr:    Para los IEEE Transactions, con citación numárica y ordenación de r
