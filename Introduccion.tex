...
Este capítulo aborda la motivación\index{motivación} del trabajo. Se trata de 
señalar la necesidad de la que surge, su actualidad y pertinencia. Puede 
incluir también un estado de la cuestión en la que se revisen estudios o 
desarrollos previos y en qué medida sirven de base al trabajo que se presenta.
...
\begin{figure}[htb]
	...
	(Escuela Superior de Informática)}\index{ESI}
	\label{fig:ejFigure}
\end{figure}


\noindent Ejemplo de figuras compuestas por subfiguras.
¡Ojo! porque el paquete subfigure ha quedado 
obsoleto.\index{figuras!subfiguras}
...
de una Escuela de Informática.} (Tecnologías de la Información y 
