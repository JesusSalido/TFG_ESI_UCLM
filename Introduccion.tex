...
En este capítulo debería introducirse el \emph{contexto disciplinar y tecnológico} en el que se desarrollará el trabajo de modo que pueda entenderse con facilidad el ámbito y alcance del TFG.\index{TFG} Puesto que un TFG no tiene que ser necesariamente un trabajo con aportes novedosos u originales, sólo es necesario la inclusión de un <<estado del arte>> cuando este contribuya a aclarar aspectos clave del TFG desarrollado o se desee justificar la originalidad del trabajo realizado.
