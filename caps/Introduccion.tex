...
\begin{enumerate}
    ...
    \item \textbf{Antecedentes} o Contexto disciplinar/tecnológico. También puede denominarse \emph{Estado del Arte} cuando se trata de comentar trabajos relacionados que han abordado la cuestión u objetivo que se plantea.
...
\LaTeX{} y paquetes dedicados. Para la realización de tablas más complejas se recomienda la consulta de \cite{borbon21} y el empleo de asistentes o herramientas en línea.\footnote{\url{https://www.tablesgenerator.com/}}
